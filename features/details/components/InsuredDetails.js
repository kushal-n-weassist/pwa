...
export default function InsuredDetails() {
  ...
  // When same-as-patient is checked, display patient data in the fields
  const displayData = insuredData.isSameAsPatient ? patientData : insuredData;
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
        <div>
          ...
          <Input
            isDisabled={isReadOnly || insuredData.isSameAsPatient}
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            ...
            <Input
              ...
              onClick={(e) =>
                !(isReadOnly || insuredData.isSameAsPatient) && e.target.showPicker?.()
              }
            />
          </div>
          <div className="flex-1">
            ...
            <Select
              ...
              selectedKeys={displayData.gender ? [displayData.gender] : []}
